...
public class dataAccess {
    ...
    public String createUserDetails(String userID, String userEmail, String userPassword, String userName, String userPosition) {
        return "INSERT INTO userdb (userID, Email, Password, Name, Position) VALUES ('" + userID + "', '" + userEmail + "', '" + userPassword + "', '" + userName + "', '" + userPosition + "')";
    }
    
    public String updateUserDetails(String userID, String userPassword, String userPosition) {
        return "UPDATE userdb SET Password = '" + userPassword + "', Position = '" + userPosition + "' WHERE userID = '" + userID + "'";
    }
    
    public String deleteUserDetails(String userID) {
        return "DELETE FROM userdb WHERE userID = '" + userID + "'";
    }
