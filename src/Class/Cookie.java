...
public class Cookie extends Product {
    ...
    public String toString() {
        return "Cookie{" + "cookieBakedStock=" + cookieBakedStock + ", cookieDoughStock=" + cookieDoughStock + ", pikMorningPrepWky=" + pikMorningPrepWky + ", pikReBakingPointWky=" + pikReBakingPointWky + ", pikMorningPrepWkd=" + pikMorningPrepWkd + ", pikReBakingPointWkd=" + pikReBakingPointWkd + ", pkbwMorningPrepWky=" + pkbwMorningPrepWky + ", pkbwReBakingPointWky=" + pkbwReBakingPointWky + ", pkbwMorningPrepWkd=" + pkbwMorningPrepWkd + ", pkbwReBakingPointWkd=" + pkbwReBakingPointWkd + '}';
    }
